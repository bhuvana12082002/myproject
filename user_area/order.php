...
//getting total items and total price of alll items
...
$insert_order="insert into user_orders (user_id,amount_due,invoice_number,total_products,
...
echo "<script>window.open('billing.php','_self')</script>";
}
